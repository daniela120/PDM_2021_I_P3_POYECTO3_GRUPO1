...
class Produccion : AppCompatActivity() {
    ...
    private fun callServiceGetProducto() {
        ...
        var result: Call<List<ProductoDataCollectionItem>> = productosService.listProductos()
        ...
        result.enqueue(object : Callback<List<ProductoDataCollectionItem>> {
            ...
            override fun onResponse(
                ...
                try {
                    ...
                    println("No hay datos de get producto")
    ...
    fun initial(a:HashSet<String>){
        ...
        spinner_Puestos.onItemSelectedListener = object:
            ...
            {
                callServiceGetProductosById(A[position].toString().toLong())
            }
        }


    }
    fun initial1(a:HashSet<String>){
    ...
    private fun callServiceGetProductosById(a:Long) {
        var nombrep=""
    ...
    private  fun  callServiceGetEmpleadoById(a:Long) {
        var nombrep=""
        val empleadoService:EmpleadoService= RestEngine.buildService().create(EmpleadoService::class.java)
        var result: Call<EmpleadoDataCollectionItem> =empleadoService.getEmpleadoById(a)
